...
public class RxNetworkMgr {
        ...
        if (context != null) {
            ...
            if (mNetworkInfo != null) {
                ...
                if(ConnectivityManager.TYPE_MOBILE == mNetworkInfo.getType()){
                    KLog.i("RxNetworkMgr", "网络连接类型为：TYPE_MOBILE");
                    //判断移动网络连接状态
    ...
    public static boolean isNetworkConnected(Activity activity){
        boolean falg = false;
        ConnectivityManager mConnectivityManager = (ConnectivityManager) activity.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);//"connectivity"
