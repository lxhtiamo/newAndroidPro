...
public class RxScreenTool {
    ...
    public static int getNavigationAreaHeight(Context context) {
        int realScreenHeight = RxScreenTool.getRealScreenHeight(context);
        int screenHeight = RxScreenTool.getScreenHeight(context);
    ...
    public static String shoot(Activity a) {
        ...
        boolean ret = RxScreenTool.savePic(RxScreenTool.takeScreenShot(a), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
    ...
    public static String shootWebView(Context context, WebView webView) {
        ...
        boolean ret = RxScreenTool.savePic(RxScreenTool.captureWebView(webView), localPath);
        if (ret) {
            return localPath;
        } else {
            return "";
