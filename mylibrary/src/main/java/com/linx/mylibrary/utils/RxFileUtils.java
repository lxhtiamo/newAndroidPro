...
import com.linx.mylibrary.utils.base64.BASE64Decoder;
import com.linx.mylibrary.utils.base64.BASE64Encoder;
...
import static com.linx.mylibrary.utils.RxValidationTool.convertStreamToString;
...
public class RxFileUtils {
    ...
    private static final String TAG = RxFileUtils.class.getSimpleName();
    ...
    public static File createFileDir(Context context, String dirName) {
        ...
        if (!destDir.exists()) {
            ...
            Log.i("RxFileUtils", filePath + " has created. " + isCreate);
        }
        return destDir;
    }
